class Header {
    ...
    */
    drawOrErase(grid, start, end, currTime, prevTime){
    ...
    eraseWall(grid, start, end){

        //As long as targets are not pressed reset box to white
        if(mouseIsPressed && !start.pressed && !end.pressed){
